...
variable "postgresql_image_repository" { default = "proxy-chainguard/cosmotech/postgres-cloudnative-pg-fips" } ## Note: not only used in postgresql module, but also in others modules to ensure psql is the same everywhere
...
variable "seaweedfs_image_repository" { default = "proxy-chainguard/cosmotech/seaweedfs-iamguarded" }
variable "seaweedfs_image_tag" { default = "4.43" }
variable "seaweedfs_storage_size" { default = 32 }


## Argo Workflows
# variable "argo_workflows_chart_repository" { default = "oci://cgr.dev/cosmotech/iamguarded-charts" }
variable "argo_workflows_chart_name" { default = "argo-workflows" }
variable "argo_workflows_chart_tag" { default = "13.0.6" }
variable "argo_workflows_image_repository_prefix" { default = "cosmotech/argo-workflow" } ## Prefix, because Argo Workflows is composed of multiple images
...
variable "redis_image_repository" { default = "proxy-chainguard/cosmotech/redis-server-iamguarded" }
...
# variable "cosmotech_running_api_chart_repository" { default = "oci://registry.cosmotech.com/product-charts" }
variable "cosmotech_running_api_chart_name" { default = "cosmotech-api" }
variable "cosmotech_running_api_chart_tag" { default = "5.1.0" }
variable "cosmotech_running_api_image_repository" { default = "product/cosmotech-api" }
variable "cosmotech_running_api_image_tag" { default = "12.3.0" }


## Cosmo Tech Modeling API
# variable "cosmotech_modeling_api_chart_repository" { default = "oci://registry.cosmotech.com/product-charts" }
...
variable "cosmotech_modeling_api_image_repository" { default = "product/cosmotech-modeling-api" }
...
# variable "cosmotech_asset_data_layer_chart_repository" { default = "oci://registry.cosmotech.com/product-charts/cosmotech-asset-data-layer-api" }
...
variable "cosmotech_asset_data_layer_image_repository" { default = "product/cosmotech-asset-data-layer" }
...
# variable "cosmotech_asset_investment_planning_api_chart_repository" { default = "oci://registry.cosmotech.com/product-charts/cosmotech-asset-investment-planning-helm" }
...
variable "cosmotech_asset_investment_planning_api_image_repository" { default = "product/cosmotech-asset-investment-planning-api" }
...
# variable "cosmotech_asset_investment_planning_webapp_chart_repository" { default = "oci://registry.cosmotech.com/product-charts/cosmotech-asset-investment-planning-helm" }
variable "cosmotech_asset_investment_planning_webapp_chart_name" { default = "asset-investment-planning-webapp" }
variable "cosmotech_asset_investment_planning_webapp_chart_tag" { default = "0.2.0" }
variable "cosmotech_asset_investment_planning_webapp_image_repository" { default = "product/cosmotech-asset-investment-planning-webapp" }
variable "cosmotech_asset_investment_planning_webapp_image_tag" { default = "changeme" }


## Global
variable "helm_repo" { default = "oci://registry.cosmotech.com" }
