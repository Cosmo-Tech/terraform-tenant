...
variable "argo_workflows_image_prefix" { default = "argo-workflows" } ## Prefix, because Argo Workflows is composed of multiple images
...
variable "cosmotech_run_api_image_tag" { default = "12.3.0" }
