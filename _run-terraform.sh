...
tenant_namespace="$(echo "local.tenant_namespace" | terraform console -var-file="terraform.tfvars" | tr -d '"')"
echo "$NO_FORMAT"
echo "target is $FG_COLOR_INFO$cluster_name/$tenant_namespace"
